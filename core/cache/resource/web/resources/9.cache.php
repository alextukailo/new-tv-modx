<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1690451914,
    'editedby' => 1,
    'editedon' => 1690451950,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1690451950,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'region_image',
      1 => 'assets/images/content/arial3.png',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<section>
    <div class="section__inner service-single__inner">
        <div class="container">
            <div class="service__content mb_3">
                <div class="service__info">
                    <h1 class="header_h1 mb_3">Щёлково</h1>
                    <p class="text_body2">test</p>
                </div>
                <img src="assets/images/content/arial3.png" alt="Щёлково">
            </div>
    ...
    <div class="section__inner">
        <div class="container">
            <h3 class="section__header text_start header_h3">
                Расценки на настройку цифрового ТВ
            </h3>
            <table class="table mb_6">
              <thead>
                <th>Виды услуг</th>
                <th>Цены</th>
              </thead>
            ...
            <div class="tabs">
                <ul class="tabs-heading__list mb_4">
                    [[!getImageList?
                        &tvname=`region_gallery`
                        &tpl=`regionTabsTpl`
                        &includeTVs=`1`
                        &processTVs=`1`
                        &docid=`5`
...
<script src="assets/js/index.js"></script>
    ...
    '[[getImageList?
    &value=`[{"MIGX_id":"1","title":"NTV","image":"assets\\/images\\/content\\/arial4.png"},{"MIGX_id":"2","title":"NTV2","image":"assets\\/images\\/content\\/arial4.png"}]`
    &tpl=`regionGalleryInnerTpl`
]]' => '<li class="tabs-content__item">
    <div class="tabs-content__inner">
        <img src="assets/images/content/arial4.png" alt=\'NTV\'>
        <h6>NTV</h6>
    </div>
</li><li class="tabs-content__item">
    <div class="tabs-content__inner">
        <img src="assets/images/content/arial4.png" alt=\'NTV2\'>
        <h6>NTV2</h6>
    </div>
</li>',
    '[[getImageList?
    &value=`[{"MIGX_id":"1","title":"NTV","image":"assets\\/images\\/content\\/arial4.png"},{"MIGX_id":"2","title":"NTV3","image":"assets\\/images\\/content\\/arial1.png"}]`
    &tpl=`regionGalleryInnerTpl`
]]' => '<li class="tabs-content__item">
    <div class="tabs-content__inner">
        <img src="assets/images/content/arial4.png" alt=\'NTV\'>
    ...
    <div class="tabs-content__inner">
        <img src="assets/images/content/arial1.png" alt=\'NTV3\'>
        <h6>NTV3</h6>
    </div>
</li>',
    '[[getImageList?
    &value=`[{"MIGX_id":"1","title":"РТР","image":"assets/images/content/arial3.png"},{"MIGX_id":"2","title":"РТР2","image":"assets/images/content/arial4.png"}]`
    &tpl=`regionGalleryInnerTpl`
]]' => '<li class="tabs-content__item">
    <div class="tabs-content__inner">
        <img src="assets/images/content/arial3.png" alt=\'РТР\'>
        <h6>РТР</h6>
    </div>
</li><li class="tabs-content__item">
    <div class="tabs-content__inner">
        <img src="assets/images/content/arial4.png" alt=\'РТР2\'>
        <h6>РТР2</h6>
    </div>
</li>',
    '[[getImageList?
    &value=`[{"MIGX_id":"1","title":"Т","image":"assets/images/content/arial1.png"}]`
    &tpl=`regionGalleryInnerTpl`
]]' => '<li class="tabs-content__item">
    <div class="tabs-content__inner">
        <img src="assets/images/content/arial1.png" alt=\'Т\'>
        <h6>Т</h6>
    </div>
</li>',
  ),
